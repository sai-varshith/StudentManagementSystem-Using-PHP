    ...
    <div class="content">
      ...
      <?php
        ...
        ?>
          ...
          <input type="reg" id="input1"  placeholder="Enter Your Registration Number to continue" required="" name="sr_id">
...
<form action="" method="post" class="form-horizontal col-md-6 col-md-offset-3" style="margin-top:15px;">
   <table class="table table-striped">
          ...
          <tr>
            ...
            <td><span style="margin-left: 20px;"><?php echo $data['st_id']; ?></span></td>
          </tr>
